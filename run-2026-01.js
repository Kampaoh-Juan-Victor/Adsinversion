...
const TMP_PATH = path.join(DIR, "data-tmp-2026-01.json");
...
const PROMPT = `Consulta Portermetrics para el período 2026-01-01 a 2026-01-31 y escribe el resultado en ${TMP_PATH}.
...
if (fs.existsSync(TMP_PATH)) {
  console.log("✅ data-tmp-2026-01.json generado");
