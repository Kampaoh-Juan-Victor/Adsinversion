...
const TMP_PATH = path.join(DIR, "data-tmp-2025-09.json");
...
const PROMPT = `Consulta Portermetrics para el período 2025-09-01 a 2025-09-30 y escribe el resultado en ${TMP_PATH}.
...
if (fs.existsSync(TMP_PATH)) {
  console.log("✅ data-tmp-2025-09.json generado");
